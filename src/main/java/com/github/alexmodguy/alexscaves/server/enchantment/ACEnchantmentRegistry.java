...
public class ACEnchantmentRegistry {
    ...
    public static final RegistryObject<Enchantment> TAXING_BELLOW = DEF_REG.register("taxing_bellow", () -> new ACWeaponEnchantment("taxing_bellow", Enchantment.Rarity.VERY_RARE, MAGIC_CONCH, 1, 19, true, EquipmentSlot.MAINHAND));
